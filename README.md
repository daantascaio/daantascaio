...
### About me
Studying technology to help more and more people is my goal. With over five years of experience in the IT field, I am currently working as an Infrastructure Analyst. I have experience with VMware, Zabbix for monitoring, and I use Samba for managing file sharing and network file management. I am also responsible for network security, using Sophos to control permissions and BitLocker for disk encryption management, as well as planning new security measures for the company.
...
*CCNA*  <!-- |  *Shell* |  *Linux* |  *Sec* |  *SysAdmi*    *Computer Science* | *Python* | *DevOps* --> 
<br/>
